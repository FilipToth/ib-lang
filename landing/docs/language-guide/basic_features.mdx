...
- **String Concatenation**: Join two objects of type `String` (or a string and an `Any` object) together using the `+` operator. Example: `"Result: " + (54 * 6)` evaluates to `Result: 324`.
